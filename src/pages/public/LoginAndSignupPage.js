   ...
   return (
      <section className="relative top-16 flex justify-center items-center md:top-14">
         <div className="w-full relative top-8 flex justify-center items-center md:top-6">
            <div className="flex justify-start items-start w-[70%] rounded-lg md:w-[95%] md:flex-col md:mb-6">
               <div className="w-[50%] flex justify-center items-center h-full rounded-l-lg md:w-full md:py-4 md:rounded-l-none md:rounded-t-lg">
